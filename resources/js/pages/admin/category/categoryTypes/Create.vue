...
const submit = () => {
    form.post(route('admin.category.types.store'))
}
</script>
        ...
        <template #content>
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-xl font-semibold text-gray-800">Создание подкатегории</h3>
                ...
                <form @submit.prevent="submit" class="max-w-2xl space-y-6">
                    ...
                    <div class="flex gap-3 pt-4">
                        <button type="submit" :disabled="form.processing"
                            ...
                            {{ form.processing ? 'Сохранение...' : 'Создать подкатегорию' }}
                        </button>
                        <Link :href="route('admin.category.types.index')"
