<!-- resources/js/Pages/Admin/Workshop/Edit.vue -->
<script setup>
...
const imagePreview = ref(props.service.image_path || null);
...
// Обновление
const updateService = () => {
    form.put(route('admin.workshop.update', props.service.id), {
        preserveScroll: true,
    });
};
</script>
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Редактирование услуги</h1>
                            <p class="text-gray-500 mt-1">Измените информацию об услуге мастерской</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="updateService">
                        ...
                        <div class="mb-6">
                            ...
                            <div v-if="imagePreview" class="mb-4">
                                ...
                                <p class="text-xs text-gray-400 mt-2">Текущее изображение</p>
                            </div>
                ...
                <div class="mt-4 text-center text-xs text-gray-400">
                    <p>Создано: {{ service.created_at }} | Обновлено: {{ service.updated_at }}</p>
                </div>
            </div>
        </template>
    </ProfileLayout>
